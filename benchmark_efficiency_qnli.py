...
DATA_DIR = os.path.join(PROJECT_DIR, "data", "QNLI")
NUM_REPEATS = 10
...
def load_dev_data(data_dir):
    """读取 QNLI 验证集，返回 token 序列列表
    QNLI 格式: index\tquestion\tsentence\tlabel
    将 question 和 sentence 拼接为一个文本序列
    """
