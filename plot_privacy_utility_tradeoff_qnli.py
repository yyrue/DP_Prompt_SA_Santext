"""
Privacy-Utility Tradeoff 对比图 (QNLI)
用法:
    python plot_privacy_utility_tradeoff_qnli.py                          # 画所有已有的 mixed 曲线
    python plot_privacy_utility_tradeoff_qnli.py --eps_high 24            # 只画 eps_high=24
    python plot_privacy_utility_tradeoff_qnli.py --eps_high 18 24         # 画 eps_high=18 和 24
    python plot_privacy_utility_tradeoff_qnli.py --eps_high 16 18 24      # 画 eps_high=16, 18, 24
"""
...
MIXED_DATA_CONFIG = {
    24: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps24.csv',
        'attack_csv':  'mask_attack_results_QNLI_mixed_eps24.csv',
        'color':       '#E91E63',   # 粉红
        'marker':      's',         # 方形
    },
    18: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps18.csv',
        'attack_csv':  'mask_attack_results_QNLI_mixed_eps18.csv',
        'color':       '#FF9800',   # 橙色
        'marker':      'D',         # 菱形
    },
    16: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps16.csv',
        'attack_csv':  'mask_attack_results_QNLI_mixed_eps16.csv',
        'color':       '#4CAF50',   # 绿色
        'marker':      '^',         # 三角形
    },
    20: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps20.csv',
        'attack_csv':  'mask_attack_results_QNLI_mixed_eps20.csv',
        'color':       '#9C27B0',   # 紫色
        'marker':      'v',         # 倒三角
    },
    22: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps22.csv',
        'attack_csv':  'mask_attack_results_QNLI_mixed_eps22.csv',
        'color':       '#795548',   # 棕色
        'marker':      'p',         # 五角星
    },
    # ---- 添加新的 eps_high 只需复制下面的模板 ----
    # 14: {
    #     'utility_csv': 'utility_results_QNLI_bert_mixed_eps14.csv',
    #     'attack_csv':  'mask_attack_results_QNLI_mixed_eps14.csv',
    #     'color':       '#607D8B',   # 蓝灰
    #     'marker':      'h',         # 六角形
    # },
...
# SanText 基线数据（固定不变）
SANTEXT_CONFIG = {
    'utility_csv': 'utility_results_QNLI_bert.csv',
    'attack_csv':  'mask_attack_results_QNLI.csv',
    'color':       '#2196F3',   # 蓝色
    'marker':      'o',         # 圆形
}
...
def main():
    parser = argparse.ArgumentParser(description='Plot Privacy-Utility Tradeoff (QNLI)')
    parser.add_argument('--eps_high', nargs='*', type=int, default=None,
                        help='要画的 eps_high 值列表，如 --eps_high 18 24。不指定则画所有已有数据。')
    parser.add_argument('--output', type=str, default='privacy_utility_tradeoff_santext_vs_mixed_qnli',
                        help='输出文件名前缀（不含扩展名）')
