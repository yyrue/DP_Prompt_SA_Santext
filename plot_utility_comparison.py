...
santext_csv = os.path.join(PROJECT_DIR, "utility_results_SST2_bert.csv")
mixed_csvs = {
    "Mixed (ε_high=16)": os.path.join(PROJECT_DIR, "utility_results_SST2_bert_mixed_eps16.csv"),
    "Mixed (ε_high=18)": os.path.join(PROJECT_DIR, "utility_results_SST2_bert_mixed_eps18.csv"),
    "Mixed (ε_high=20)": os.path.join(PROJECT_DIR, "utility_results_SST2_bert_mixed_eps20.csv"),
    "Mixed (ε_high=22)": os.path.join(PROJECT_DIR, "utility_results_SST2_bert_mixed_eps22.csv"),
    "Mixed (ε_high=24)": os.path.join(PROJECT_DIR, "utility_results_SST2_bert_mixed_eps24.csv"),
}
...
print("Baseline epsilon 值:", santext_epsilons)
...
ax.set_title("Utility Comparison: Baseline vs Sample Amplification (SST-2, BERT)", fontsize=15)
...
# 7. 保存图片
# ============================================================
output_png = os.path.join(PROJECT_DIR, "utility_comparison_santext_vs_mixed.png")
output_pdf = os.path.join(PROJECT_DIR, "utility_comparison_santext_vs_mixed.pdf")
