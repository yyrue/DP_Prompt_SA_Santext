...
# -*- coding: utf-8 -*-
"""
绘制 Defense Rate 对比图（Mask Token Inference Attack）
- X 轴: epsilon
- Y 轴: Defense Rate
- 对比线:
  1. SanText（原始算法）
...
santext_csv = os.path.join(PROJECT_DIR, "mask_attack_results_SST2_v2.csv")
mixed_csvs = {
    "Mixed (ε_high=16)": os.path.join(PROJECT_DIR, "mask_attack_results_SST2_mixed_eps16.csv"),
    "Mixed (ε_high=18)": os.path.join(PROJECT_DIR, "mask_attack_results_SST2_mixed_eps18.csv"),
    "Mixed (ε_high=20)": os.path.join(PROJECT_DIR, "mask_attack_results_SST2_mixed_eps20.csv"),
    "Mixed (ε_high=22)": os.path.join(PROJECT_DIR, "mask_attack_results_SST2_mixed_eps22.csv"),
    "Mixed (ε_high=24)": os.path.join(PROJECT_DIR, "mask_attack_results_SST2_mixed_eps24.csv"),
}
...
# SanText 的所有 epsilon
santext_epsilons = sorted(santext_mean.keys())
...
ax.set_title("Privacy Comparison: Baeseline vs Mixed Sampling — Mask Token Attack (SST-2)", fontsize=15)
...
# 7. 保存图片
# ============================================================
output_png = os.path.join(PROJECT_DIR, "defense_rate_comparison_santext_vs_mixed.png")
output_pdf = os.path.join(PROJECT_DIR, "defense_rate_comparison_santext_vs_mixed.pdf")
