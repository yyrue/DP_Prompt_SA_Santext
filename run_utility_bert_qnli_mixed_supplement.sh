#!/bin/bash
# ============================================================
# SanText Utility 补充实验脚本 (Mixed 数据版本) — QNLI 数据集
# 用途: 对已有 mixed 数据目录中补充的 epsilon' 进行微调
# 结果追加到已有的汇总 CSV 文件中
#
# 用法:
#   CUDA_VISIBLE_DEVICES=4 bash run_utility_bert_qnli_mixed_supplement.sh 24 22 24
#   参数1: EPS_HIGH（默认 16）
...
echo "============================================"
echo " SanText Utility 补充实验 (QNLI, Mixed 数据)"
