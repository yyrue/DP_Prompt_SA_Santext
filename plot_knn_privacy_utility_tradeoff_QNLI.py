"""
Privacy-Utility Tradeoff 对比图 (KNN Attack Top-10, QNLI)
用法:
    python plot_knn_privacy_utility_tradeoff_QNLI.py                          # 画所有已有的 mixed 曲线
    python plot_knn_privacy_utility_tradeoff_QNLI.py --eps_high 24            # 只画 eps_high=24
    python plot_knn_privacy_utility_tradeoff_QNLI.py --eps_high 18 24         # 画 eps_high=18 和 24
"""
...
MIXED_DATA_CONFIG = {
    16: {
        ...
        'attack_csv':  'knn_attack_results_QNLI_mixed_eps16_Top10.csv',
        'color':       '#4CAF50',
        'marker':      '^',
    },
    18: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps18.csv',
        'attack_csv':  'knn_attack_results_QNLI_mixed_eps18_Top10.csv',
        'color':       '#FF9800',
        'marker':      'D',
    },
    20: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps20.csv',
        'attack_csv':  'knn_attack_results_QNLI_mixed_eps20_Top10.csv',
        'color':       '#9C27B0',
        'marker':      'v',
    },
    22: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps22.csv',
        'attack_csv':  'knn_attack_results_QNLI_mixed_eps22_Top10.csv',
        'color':       '#795548',
        'marker':      'p',
    },
    24: {
        'utility_csv': 'utility_results_QNLI_bert_mixed_eps24.csv',
        'attack_csv':  'knn_attack_results_QNLI_mixed_eps24_Top10.csv',
        'color':       '#E91E63',
        'marker':      's',
    },
}
...
SANTEXT_CONFIG = {
    ...
    'attack_csv':  'knn_attack_results_QNLI_Top10.csv',
    'color':       '#2196F3',
    'marker':      'o',
}
...
def main():
    parser = argparse.ArgumentParser(description='Plot Privacy-Utility Tradeoff (KNN Attack, QNLI)')
    parser.add_argument('--eps_high', nargs='*', type=int, default=None,
                        help='要画的 eps_high 值列表，如 --eps_high 18 24。不指定则画所有已有数据。')
    parser.add_argument('--output', type=str, default='knn_privacy_utility_tradeoff_QNLI_santext_vs_mixed',
                        help='输出文件名前缀（不含扩展名）')
